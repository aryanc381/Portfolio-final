function Research() {
  return (
    <div className='md:fixed md:top-[25.7vw] md:left-[31.54vw] shadow-lg grid justify-center bg-[#ffffff] m-[1vw] mt-[2.5vw] mb-[] mr-[2.5vw] ml-[2.5vw] pt-[3vw] pb-[4vw] pr-[3vw] pl-[3vw] rounded-xl border-[0.1vw] border-gray-200 md:pt-[0.3vw] md:pb-[1vw] md:pr-[2vw] md:pl-[2vw] md:w-[21.6vw]'>
          <p className='text-[6.4vw] tracking-[-0.30vw] font-[500] md:text-[1.8vw] md:tracking-[-0.05vw]'>Research - IEEE</p>
          <p className=' mt-[2vw] text-[5vw] md:text-[1.5vw] md:tracking-[-0.05vw] md:mt-[0vw]'>Conference Paper</p>
