function Education() {
  return (
    <div className='shadow-lg grid justify-center bg-[#ffffff] m-[1vw] mt-[2.5vw] mb-[] mr-[2.5vw] ml-[2.5vw] pt-[3vw] pb-[4vw] pr-[3vw] pl-[3vw] rounded-xl border-[0.1vw] border-gray-200 md:fixed md:pt-[1vw] md:pb-[1vw] md:pl-[1vw] md:pr-[1vw] md:mt-[20.2vw] md:mb-[1vw] md:ml-[1vw] md:mr-[0vw]'>
        <p className='text-[6.4vw] tracking-[-0.30vw] font-[500] pl-[0.2vw] pb-[0.5vw] md:text-[1.8vw] md:tracking-[-0.1vw] md:pb-[0vw]'>Education</p>
